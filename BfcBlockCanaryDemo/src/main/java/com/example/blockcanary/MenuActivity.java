...
import com.example.blockcanary.config.ConfigActivity;
import com.example.blockcanary.test.DemoActivity;
...
public class MenuActivity extends ABaseActivity {
    ...
    protected void initData() {
        mVersionTv.setText(TextUtils.concat(
                "BlockCanary版本：", BlockCanary.getVersion()
        ));
    }
    ...
    protected void onResume() {
        mNotificationTipLl.setVisibility(Config.displayNotification && !CommonUtils.isNotificationEnabled(this)
