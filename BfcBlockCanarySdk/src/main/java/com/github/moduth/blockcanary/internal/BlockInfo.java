...
public class BlockInfo {
    ...
    private StringBuilder basicSb = new StringBuilder(500);
    private StringBuilder cpuSb = new StringBuilder(500);
    private StringBuilder timeSb = new StringBuilder(500);
    private StringBuilder stackSb = new StringBuilder(2000);
    ...
    public BlockInfo flushString() {
        ...
        basicSb.append(KEY_SDK_NAME).append(KV).append(SDKVersion.getLibraryName()).append(separator);
        basicSb.append(KEY_SDK_VERSION).append(KV).append(SDKVersion.getVersionName()).append(separator);
